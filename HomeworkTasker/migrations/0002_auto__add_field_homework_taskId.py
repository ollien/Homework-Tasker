...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Homework.taskId'
        db.add_column(u'HomeworkTasker_homework', 'taskId',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Homework.taskId'
        db.delete_column(u'HomeworkTasker_homework', 'taskId')
